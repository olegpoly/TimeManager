...
public class TimePeriodTable {
    ...
    static public ContentValues makeContentValues(TimePeriodDBTableEntry tp) {
     ...
     */
    static public List<TimePeriodDBTableEntry> getAll() {
     ...
     */
    static public List<TimePeriodDBTableEntry> getAll(long session, long userActivityID) {
        UserActivityDB database = UserActivityDB.getInstance();
        SQLiteDatabase db = database.getWritableDatabase();
    ...
    // TODO: write comment
    static public List<TimePeriodDBTableEntry> getAll(long userActivityID) {
        UserActivityDB database = UserActivityDB.getInstance();
        SQLiteDatabase db = database.getWritableDatabase();
        Cursor cursor = db.rawQuery(TimePeriodTable.getAllEntries() +
    ...
    static public Long getAllTime(long userActivityID) {
        ...
        List<TimePeriodDBTableEntry> all = getTimePeriodListFromCursor(cursor);

        Long result = 0L;

        for (TimePeriodDBTableEntry tp : all) {
     ...
     */
    private static List<TimePeriodDBTableEntry> getTimePeriodListFromCursor(Cursor cursor) {
     ...
     */
    static public void add(TimePeriodDBTableEntry timePeriod) {
        UserActivityDB database = UserActivityDB.getInstance();
        SQLiteDatabase db = database.getWritableDatabase();
